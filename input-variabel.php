    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Input Variabel</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Input Variabel</h5>
              ...
              <form class="row g-3 needs-validation" novalidate>
               ...
               <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama Variabel</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="txtnamavariabel" name="txtnamavariabel" required>
                    <div class="invalid-feedback">Nama Variabel</div>
                  </div>
                </div>
...
Daftar Aspek
              <table class="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Namas Variabel</th>
              ...
              $result = mysqli_query($connection, "select v.id,id_aspek,a.nama,SUBSTR(v.kode,2,2) kode,v.nama nmvar FROM tbl_variabel v,tbl_aspek a WHERE id_aspek=a.id  ORDER BY v.id");
               $n=0;
