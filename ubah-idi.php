...
$query=mysqli_query($connection,"select * from tbl_idi where sha1(id_indikator)='$id_indikator' and oprdata<>'D'");
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Ubah Perolehan Data</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Ubah Perolehan Data</h5>
 ...
 <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                     <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" id="smb_surat" name="smb_surat" <?php
                       if($data4['smb_surat']==1){ echo "checked";}else{ echo "";}?> >
                  ...
                  <div class="col-sm-10">
                     <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" id="smb_tv" name="smb_tv" <?php
                       if($data4['smb_tv']==1){ echo "checked";}else{ echo "";}?>>
                  ...
                  <div class="col-sm-10">
                     <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" id="smb_dok" name="smb_dok" <?php
                       if($data4['smb_dok']==1){ echo "checked";}else{ echo "";}?>>
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="ketsumber" name="ketsumber" required value="<?php echo $data4['ket'];?>">
               ...
               <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="tstsurat" name="txtsurat" required value="<?php echo $data4['srt_kabar'];?>" min="0">
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="txttv" name="txttv" required value="<?php echo $data4['televisi'];?>" min="0">
                    <div class="invalid-feedback">Isian Tidak Diijinkan</div>
                  </div>
                </div>
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="txtdoc" name="txtdoc" required value="<?php echo $data4['dokumen'];?>" min="0">
                    <div class="invalid-feedback">Isian Tidak Diijinkan</div>
                  </div>
                </div>
...
<div class="row mb-3">
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="tfgd" name="tfgd" required value="<?php echo $data4['fgd'];?>" min="0">
                    <div class="invalid-feedback">Isian Tidak Diijinkan</div>
                  </div>
                </div>
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="tedd" name="tedd" required value="<?php echo $data4['edd'];?>" min="0">
                    <div class="invalid-feedback">Isian Tidak Diijinkan</div>
                  </div>
                </div>
                  ...
                  <div class="row mb-3">
                  <div class="col-sm-10">
                    <input type="hidden" class="form-control" id="txtidi" name="txtidi" required value="<?php echo $data4['id'];?>">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="submit" id="btnsimpan" name="btnsimpan" class="btn btn-primary">Ubah</button> 
                  </div>
